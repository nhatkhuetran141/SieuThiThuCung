...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 27, 2022 at 11:50 AM
...
(6, 'Mai Hông Ngọc', 'hongngoc46@gmail.com', '123', '1995-05-11', 'X. Đa Tốn, H. Gia Lâm, TP. Hà Nội', 'Female', '0958587458', 'avatar6.png', 0, 0, '2022-06-27 15:05:00', '2022-06-27 15:05:00'),
...
(1, 'True Hemp™ Treats – Calming by True Leaf', 1, 'Whiskas', 200, '<div>We know the difficulty of seeing our pets stressed from loud noises, separation anxiety and even our own mood swings.</div><div>This unique formulation incorporates hemp leaf, green tea, chamomile and lemon balm to help reduce tension and bring True Hemp™ CALMING to our most sensitive companions.</div><div><br></div>', 3.29, 'product1-hinh1.jpg', 'product1-hinh2.jpg', 'empty_product.png'),
(2, 'Cat Stocking with mix of cat toys and treats', 1, 'Promina', 200, '<div>With christmas on the horizon it’s time to get your kitties the purrfect Cat Stocking filled with cat goodies! ?</div><div>Each stocking contains a mixture of cat toys and one bag of treats with a total value of £14 – £17.00 and the toys &amp; treats have been carefully selected by your very own Santa Claws Nubia</div><div>PLEASE NOTE WE HAVE A RANDOM SELECTION OF STOCKINGS NOW; HIGH QUALITY BUT IT WAS DIFFICULT TO GET SUFFICIENT STOCK IN THE SAME DESIGN!!!! PHOTO FOR REFERENCE PURPOSE ONLY AT THIS POINT!</div>', 14, 'product2-hinh1.jpg', 'product2-hinh2.jpg', 'empty_product.png'),
...
(24, 'Rotho Lunch Box & Storage Box', 3, 'Promina', 200, 'Cute cat themed lockable storage box – click closure for secure hold – ideal for storing treats, utensils or a lunch sandwich.', 3.49, 'product22-hinh1.jpg', 'product22-hinh2.jpg', 'empty_product.png'),
(25, 'Necoichi – Extra Tall Raised Cat Water Bowl', 3, 'Company', 200, 'Give your kitty the utmost comfort during hydration with the Necoichi Raised Cat Water Bowl. By raising the water to his level instead of forcing him to bend down, it makes for easier drinking and swallowing—and it’s also great for cats with arthritis, by reducing neck strain. The inner lip means no spills, and there are even measuring lines for ease of portion control and to keep track of how much your cat is drinking. Plus, the design just so happens to be adorable!', 33.49, 'product23-hinh1.jpg', 'product23-hinh2.jpg', 'product23-hinh3.jpg'),
(26, 'ZenClipper – The Worry Free NailClipper for Pets', 3, 'Joy', 200, 'Zen Clipper a revolutionary new pet nail clipper (claw clipper) that is designed to clip just the tip of the nail! It’s completely silent and will ensure that you never hit the quick of your pet again.', 23.49, 'product24-hinh1.jpg', 'product24-hinh2.jpg', 'product24-hinh3.jpg'),
(27, 'Kat Zen Pads – The Purrfect Cat Bed for Your Felin', 3, 'Promina', 200, 'These cat sleeping pads are handmade in the UK using high-quality cotton fabric imported from Japan together with a British Made fleece lining for the back to turn any flooring, shelf or other areas into the purrfect cat zen meditation hotspot!', 15.49, 'product25-hinh1.jpg', 'product25-hinh2.jpg', 'product25-hinh3.jpg'),
...
(29, 'Jerrys Designer Cat Cave WITH airholes', 3, 'Promina', 200, 'Are you looking for one that will last for the lifetime of your furry friend? Look no further as this fabulous cave is the purrfect solution.&lt;br&gt;', 67.49, 'product27-hinh1.jpg', 'product27-hinh2.jpg', 'product27-hinh3.jpg');
