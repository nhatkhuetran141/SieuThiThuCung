...
include('handling/handling_view_coupons.php');
                ...
                <div id="content">
                    ...
                    <div class="container-fluid" id="container-wrapper">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">View Conpon</h1>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="breadcrumb-item">Conpon</li>
                                <li class="breadcrumb-item active" aria-current="page">View Conpon</li>
                            </ol>
                        </div>         
                        ...
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Conpon Information</h6>
                                </div>
                                <div class="table-responsive p-3">
                                    <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                                        ...
                                        <tbody  style="text-align: center;">
                                            <?php
                                            $query_all_coupon = mysqli_query($con, "SELECT coupon_id, coupon_name FROM coupons;");
                                            while ($row = mysqli_fetch_array($query_all_coupon)) {
                                                ?>
                                                <tr>
                                                    <td><a href="#"><?php echo htmlentities($row['coupon_id']); ?></a></td>
                                                    <td><?php echo htmlentities($row['coupon_name']); ?></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
