...
include('handling/handling_add_categories.php');
                        ...
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                ...
                                <form class="forms-sample ml-5 mb-3" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input name="product_type_name" type="text" class="form-control" id="" placeholder="Foods,..." >
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <button name="add_categories" type="submit" class="btn btn-primary me-2">Add</button>
                                </form>
                            </div>
                        </div>
