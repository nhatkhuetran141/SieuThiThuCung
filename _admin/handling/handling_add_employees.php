                ...
                if (!empty($password) && $password != "") {
                    if (strlen($password) <= '8') {
                        ...
                        while ($row = mysqli_fetch_array($query_id_account)) {
                            //insert a new customer
                            $insert_customer = mysqli_query($con, "INSERT INTO employees (account_id) VALUES ('" . $row['account_id'] . "');");
                        }
                        //count supplier
                        $update_employee = mysqli_query($con, "UPDATE count_others SET count_other=count_other+1 WHERE count_other_name='employees';");
                        if ($insert_account > 0 && $insert_customer > 0 && $update_employee) {
