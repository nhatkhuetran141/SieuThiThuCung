...
include('handling/handling_view_customers.php');
        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                                ...
                                <div class="table-responsive p-3">
                                    <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                                        ...
                                        <tbody  style="text-align: center;">
                                            <?php
                                            $infor_all_account = "accounts.account_id, account_name, phone, date_of_birth, block";
                                            $query_all_account = mysqli_query($con, "SELECT " . $infor_all_account . " FROM accounts, customers WHERE accounts.account_id=customers.account_id AND role=0;");
                                            while ($row = mysqli_fetch_array($query_all_account)) {
                                                ?>
                                                <tr>
                                                    <td><a href="#"><?php echo htmlentities($row['account_id']); ?></a></td>
                                                    <td><?php echo htmlentities($row['account_name']); ?></td>
                                                    <td><?php echo htmlentities($row['phone']); ?></td>                      
                                                    <td><?php echo htmlentities($row['date_of_birth']); ?></td>
                                                    <?php if ($row['block'] == 0) { ?>
                                                        <td><span class="badge badge-success">Activiti</span></td>
                                                        <td>  
                                                            <a href="view_customers.php?block_id=<?php echo htmlentities($row['account_id']); ?>" class="btn btn-warning btn-sm">
                                                                <i class="fas fa-lock"></i>
                                                            </a>
                                                        <?php } else { ?>
                                                        <td><span class="badge badge-warning">Locked</span></td>
                                                        <td>  
                                                            <a href="view_customers.php?unlock_id=<?php echo htmlentities($row['account_id']); ?>" class="btn btn-info btn-sm">
                                                                <i class="fas fa-unlock-alt"></i>
                                                            </a>
                                                        <?php } ?>
                                                    </td>
                                                    <td><a href="update_customers.php?account_id=<?php echo htmlentities($row['account_id']); ?>" class="btn btn-sm btn-primary">Detail</a></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
                    ...
                    <!-- Modal Delete -->
                    <div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabelLogout"
                         aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabelLogout">MeowShop check?</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                    ...
                    <!-- Modal Lock -->
                    <div class="modal fade" id="lockaccount" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabelLogout"
                         aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <p>Are you sure you want to lock account?</p>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-outline-primary" data-dismiss="modal">Cancel</button>
                                    <a href="" class="btn btn-warning">Lock</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <!-- Modal Unlock -->
                    <div class="modal fade" id="unlockaccount" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabelLogout"
                         aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <p>Are you sure you want to unlock account?</p>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-outline-primary" data-dismiss="modal">Cancel</button>
                                    <a href="" class="btn btn-info">Unlock</a>
                                </div>
                            </div>
                        </div>
                    </div>
