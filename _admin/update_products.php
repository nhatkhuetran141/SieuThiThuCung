...
include('handling/handling_update_products.php');
                        ...
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                ...
                                <form class="forms-sample ml-5 mb-3" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
                                    <?php
                                    $query_product = mysqli_query($con, "SELECT * FROM products, product_types WHERE products.product_type_id=product_types.product_type_id AND product_id=" . $_SESSION['update_by_id'] . ";");
                                    while ($row = mysqli_fetch_array($query_product)) {
                                        ...
                                        <div class="row">
                                            <div class="col-5">
                                                <div class="form-group">
                                                    ...
                                                    <input name="product_id" type="text" class="form-control" id="" value="<?php echo htmlentities($row['product_id']); ?>" disabled >
                                                </div>
                                                <div class="form-group">
                                                    <label for="">Product name</label>
                                                    <input name="product_name" type="text" class="form-control" id="" value="<?php echo htmlentities($row['product_name']); ?>">
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-5">
                                                <div class="form-group">
                                                    ...
                                                    <input name="brand" type="text" class="form-control" id="exampleInputPhone" value="<?php echo htmlentities($row['brand']); ?>">
                                                </div>
                                                ...
                                                <div action="" class="form-group">
                                                    ...
                                                    <div>
                                                        <input name="product_price" type="text" class="form-control" value="<?php echo htmlentities($row['product_price']); ?>">    
                                                    </div>                
                                                </div> 
                                            </div>            
                                        </div>
                                        ...
                                        <div class="row">
                                            <?php
                                            for ($i = 1; $i <= 3; $i++) {
                                                $product = 'product_image_' . $i;
                                                $file_old = 'file_old_' . $i;
                                                $avatar = 'avatar_' . $i;
                                                ?>
                                                <?php if ($row[$product] == '') { ?>
                                                    <div class="avatar col-3">
                                                        ...
                                                        <div class="template-demo">
                                                            <input type="hidden" name="<?php echo $file_old; ?>" value="<?php echo htmlentities($row[$product]); ?>">
                                                            <input type="file" class="btn btn-danger btn-icon-text" name="<?php echo $avatar; ?>" style="width: 180px;">
                                                        </div>
                                                    </div>
                                                <?php } else { ?>
                                                    <div class="avatar col-3">
                                                        <img src="../assets/img/image_products/<?php echo htmlentities($row[$product]); ?>" width="200" height="200" alt="Your picture">
                                                        <div class="template-demo">
                                                            <input type="hidden" name="<?php echo $file_old; ?>" value="<?php echo htmlentities($row[$product]); ?>">
                                                            <input type="file" class="btn btn-danger btn-icon-text" name="<?php echo $avatar; ?>" style="width: 180px;">
                                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-11" style="margin-bottom: 20px">
                                                ...
                                                <div>
                                                    <textarea name="product_description" id="area" style="width:70%;height:200px;"><?php echo html_entity_decode($row['product_description']); ?></textarea>
                                                </div>                
                                            </div> 
                                        </div>
                                    <?php } ?>
