...
include('handling/handling_update_employees.php');
                        ...
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                ...
                                <form class="forms-sample ml-5 mb-3" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
                                    <?php
                                    $infor_all_account = "accounts.account_id, account_name, account_address, gender, phone, date_of_birth, avatar, employee_position";
                                    $query_all_account = mysqli_query($con, "SELECT " . $infor_all_account . " FROM accounts, employees WHERE accounts.account_id=employees.account_id AND accounts.account_id=" . $_SESSION['update_by_id'] . ";");
                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="employee_position" type="text" class="form-control" value="<?php echo htmlentities($row['employee_position']); ?>">
                                                </div>
                                            </div>    
                                    ...
                                    <a href="view_employees.php" class="btn btn-light">Cancel</a>
                                </form>
                            </div>
                        </div>
