...
include('handling/handling_view_suppliers.php');
                                ...
                                <div class="table-responsive p-3">
                                    <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                                        ...
                                        <tbody  style="text-align: center;">
                                            <?php
                                            $infor_all_supplier = "supplier_id, supplier_name, supplier_phone";
                                            $query_all_account = mysqli_query($con, "SELECT " . $infor_all_supplier . " FROM suppliers;");
                                            while ($row = mysqli_fetch_array($query_all_account)) {
                                                ?>
                                                <tr>
                                                    <td><a href="#"><?php echo htmlentities($row['supplier_id']); ?></a></td>
                                                    <td><?php echo htmlentities($row['supplier_name']); ?></td>
                                                    <td><?php echo htmlentities($row['supplier_phone']); ?></td>                      
                                                    <td>  
                                                        <a href="view_suppliers.php?delete_id=<?php echo htmlentities($row['supplier_id']); ?>" class="btn btn-warning btn-sm">
                                                            <i class="fas fa-trash"></i>
                                                        </a>
                                                    </td>
                                                    <td><a href="update_suppliers.php?supplier_id=<?php echo htmlentities($row['supplier_id']); ?>" class="btn btn-sm btn-primary">Detail</a></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
