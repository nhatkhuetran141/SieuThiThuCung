...
include('handling/handling_add_suppliers.php');
                        ...
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                ...
                                <form class="forms-sample ml-5 mb-3" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="supplier_email" type="text" class="form-control">
                                                </div>   
                                                <div class="form-group">
                                                    <label for="">Address</label>
                                                    <input name="supplier_address" type="text" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label for="">Phone</label>
                                                    <input name="supplier_phone" type="text" class="form-control">
                                                </div>
                                            </div>    
                                    ...
                                    <button name="add_suppliers" type="submit" class="btn btn-primary me-2">Add</button>
                                </form>
                            </div>
                        </div>
