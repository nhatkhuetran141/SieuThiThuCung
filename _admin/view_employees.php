...
include('handling/handling_view_employees.php');
                                ...
                                <div class="table-responsive p-3">
                                    <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                                        ...
                                        <tbody  style="text-align: center;">
                                            <?php
                                            $infor_all_account = "accounts.account_id, account_name, phone, date_of_birth";
                                            $query_all_account = mysqli_query($con, "SELECT " . $infor_all_account . " FROM accounts, employees WHERE accounts.account_id=employees.account_id AND role=0;");
                                            while ($row = mysqli_fetch_array($query_all_account)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>  
                                                        <a href="view_employees.php?delete_id=<?php echo htmlentities($row['account_id']); ?>" class="btn btn-warning btn-sm">
                                                            <i class="fas fa-trash"></i>
                                                        </a>
                                                    </td>
                                                    <td><a href="update_employees.php?account_id=<?php echo htmlentities($row['account_id']); ?>" class="btn btn-sm btn-primary">Detail</a></td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
