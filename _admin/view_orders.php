...
include('handling/handling_view_orders.php');
                                ...
                                <div class="table-responsive p-3">
                                    <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                                        ...
                                        <tbody  style="text-align: center;">
                                            <?php
                                            $infor_all_order = "order_id, order_name, order_address, date_invoice_order, order_status_id";
                                            $query_all_order = mysqli_query($con, "SELECT " . $infor_all_order . " FROM orders;");
                                            while ($row = mysqli_fetch_array($query_all_order)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo htmlentities($row['date_invoice_order']); ?></td>
